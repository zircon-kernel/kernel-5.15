...
static struct LCM_setting_table mode_144hz_setting_gir_off_peak2600[] = {
	...
	{ 0xB7, 38, { 0x00, 0x00, 0x00, 0xD8, 0x01, 0x1B, 0x01, 0x1B,
		      0x01, 0xBA, 0x01, 0xBA, 0x02, 0xC7, 0x02, 0xC7,
		      0x04, 0xCD, 0x04, 0xCD, 0x07, 0xAC, 0x07, 0xAC,
		      0x0B, 0xCE, 0x0B, 0xCE, 0x0B, 0xCE, 0x0B, 0xCE,
		      0x0B, 0xCE, 0x0B, 0xCE, 0x0D, 0x48 } },
	// GIR OFF
	{ 0x5F, 01, { 0x01 } },
	{ REGFLAG_END_OF_TABLE, 0x00, {} }
};
...
static struct LCM_setting_table mode_120hz_setting_gir_off_peak2600[] = {
	...
	{ 0xE9, 04, { 0x00, 0x00, 0x00, 0x00 } }, // need update
	{ 0xB7, 38, { 0x00, 0x00, 0x00, 0x93, 0x00, 0xC0, 0x00, 0xC0,
		      0x01, 0x2C, 0x01, 0x2C, 0x01, 0xE2, 0x01, 0xE2,
		      0x03, 0x41, 0x03, 0x41, 0x05, 0x33, 0x05, 0x33,
		      0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00,
		      0x08, 0x00, 0x08, 0x00, 0x09, 0x00 } },
	// GIR OFF
	{ 0x5F, 01, { 0x01 } },
	{ REGFLAG_END_OF_TABLE, 0x00, {} }
};
...
static struct LCM_setting_table mode_60hz_setting_gir_off_peak2600[] = {
	...
	{ 0xB3,
	  14,
	  { 0x00, 0x14, 0x00, 0x14, 0x00, 0x14, 0x00, 0x14, 0x00, 0x14, 0x00,
	    0x14, 0x00, 0x14 } },
	// FCON5(HFR5, 60hz)
	{ 0x2F, 01, { 0x08 } },
	// Page8
...
static struct LCM_setting_table gir_off_120hz_settings[] = {
	...
	{ 0xB2, 24, { 0x00, 0x00, 0x00, 0x00, 0x00, 0x60, 0x0C, 0xA0,
		      0x00, 0x00, 0x00, 0x60, 0x00, 0x00, 0x00, 0x00,
		      0x00, 0x60, 0x0C, 0xA0, 0x00, 0x00, 0x00, 0x60 } },
	// BRS Setting
	{ 0xB4, 01, { 0x1C } },
	{ 0x6F, 01, { 0x0B } },
	// Reload OFF GAMMA
	{ 0xB4,
	  15,
	  { 0x1F, 0x20, 0x00, 0x0D, 0x63, 0x1F, 0x20, 0x00, 0x0D, 0x63, 0x1F,
	    0x20, 0x00, 0x0D, 0x63 } },
	// Normal，120Hz Copy
	{ 0x2F, 01, { 0x01 } },
	// Page8
...
static struct LCM_setting_table gir_on_120hz_settings[] = {
	...
	{ 0xB4,
	  15,
	  { 0x1F, 0x00, 0x00, 0x0D, 0x63, 0x1F, 0x00, 0x00, 0x0D, 0x63, 0x1F,
	    0x00, 0x00, 0x0D, 0x63 } },
	//Normal，120Hz Copy
	{ 0x2F, 01, { 0x01 } },
	// Page8
...
static char DBI_SETTING_1_R[] = { 0xCA, 0xBE, 0x80, 0x00, 0x77, 0x80, 0x80,
				  0x77, 0xC0, 0xC0, 0x67, 0x40, 0xC0, 0x66,
				  0xC0, 0xC0, 0x66, 0xC0, 0xC0 };
...
static char DBI_SETTING_1_B[] = { 0xCD, 0xBF, 0x80, 0x40, 0x88, 0x40, 0x40,
				  0x78, 0xC0, 0x80, 0x66, 0xC0, 0x00, 0x66,
...
static char DBI_SETTING_2_R[] = { 0xCA, 0xAD, 0xC0, 0xC0, 0x77, 0x80, 0x80,
				  0x77, 0x80, 0x80, 0x56, 0x40, 0x40, 0x55,
				  0x40, 0x40, 0x55, 0x40, 0x40 };
...
static char DBI_SETTING_2_B[] = { 0xCD, 0xBE, 0xC0, 0x00, 0x88, 0x40, 0x00,
				  0x88, 0x00, 0x00, 0x34, 0x80, 0x00, 0x33,
