...
static struct LCM_setting_table init_setting_peak2600[] = {
	...
	{ 0x91,
	  18,
	  { 0xAB, 0x28, 0x00, 0x0C, 0xD2, 0x00, 0x02, 0x4C, 0x01, 0x24, 0x00,
	    0x08, 0x09, 0x75, 0x07, 0x7B, 0x10, 0xF0 } },
	{ 0xFF, 04, { 0xAA, 0x55, 0xA5, 0x81 } },
	{ 0x6F, 01, { 0x0B } },
	{ 0xFD, 01, { 0x80 } },
	{ 0xFF, 04, { 0xAA, 0x55, 0xA5, 0x81 } },
	...
	{ 0xC6,
	  16,
	  { 0xA5, 0xDA, 0x55, 0x53, 0xA5, 0xDA, 0x55, 0x53, 0xA5, 0xDA, 0x55,
	    0x53, 0xA5, 0xDA, 0x55, 0x53 } },
	/* Reduce power consumption */
	{ 0xF0, 05, { 0x55, 0xAA, 0x52, 0x08, 0x05 } },
	{ 0xE1, 01, { 0x00 } },
	/* Video trim */
	{ 0xF0, 05, { 0x55, 0xAA, 0x52, 0x08, 0x01 } },
	{ 0xC3, 41, { 0xDD, 0x06, 0x22, 0x12, 0xFF, 0x00, 0x06, 0x20, 0x12,
		      0xFF, 0x00, 0x04, 0x53, 0x12, 0x05, 0xFD, 0x19, 0x04,
		      0x55, 0x12, 0x05, 0xFD, 0x19, 0x04, 0x60, 0x12, 0x05,
		      0xFD, 0x19, 0x04, 0x60, 0x12, 0x05, 0xFD, 0x19, 0x04,
...
static struct LCM_setting_table init_setting_peak2600_gamma[] = {
	...
	{ 0xB7,
	  14,
	  { 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08,
	    0x00, 0x08, 0x00 } },
	{ 0xB8,
	  16,
	  { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	...
	{ 0xB8,
	  16,
	  { 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08,
	    0x00, 0x08, 0x00, 0x0F, 0xFF } },
	{ 0x6F, 01, { 0x30 } },
	{ 0xB8,
	  16,
	  { 0x08, 0x00, 0x08, 0x00, 0x0F, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00,
	    0x00, 0x00, 0x00, 0x00, 0x00 } },
	{ 0x6F, 01, { 0x40 } },
	{ 0xB8,
	  12,
...
static struct LCM_setting_table mode_144hz_setting_gir_peak2600[] = {
	...
	{ 0xB7,
	  16,
	  { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	    0x00, 0x0C, 0xA4, 0x0C, 0xA4 } },
	{ 0x6F, 01, { 0x20 } },
	{ 0xB7,
	  14,
	  { 0x0C, 0xA4, 0x0C, 0xA4, 0x0C, 0xA4, 0x0C, 0xA4, 0x0C, 0xA4, 0x0C,
	    0xA4, 0x0C, 0xA4 } },
	{ REGFLAG_END_OF_TABLE, 0x00, {} }
};
...
static struct LCM_setting_table mode_144hz_setting_gir_peak2600_gamma[] = {
	...
	{ 0xB7,
	  14,
	  { 0x00, 0x00, 0x00, 0x00, 0x0C, 0xA4, 0x0C, 0xA4, 0x0C, 0xA4, 0x0C,
	    0xA4, 0x0C, 0xA4 } },
	{ REGFLAG_END_OF_TABLE, 0x00, {} }
};
...
static struct LCM_setting_table mode_non_144hz_setting_gir_peak2600[] = {
	...
	{ 0xB7,
	  14,
	  { 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08, 0x00, 0x08,
	    0x00, 0x08, 0x00 } },
	{ REGFLAG_END_OF_TABLE, 0x00, {} }
};
...
unsigned int m12_36_dphy_range_min_qp[15] = { 0x0, 0x0, 0x5, 0x5, 0x7,
					      0x7, 0x7, 0x7, 0x7, 0x8,
					      0x9, 0x9, 0x9, 0xc, 0x10 };
unsigned int m12_36_dphy_range_max_qp[15] = { 0x0, 0x2, 0x9, 0xa,  0xb,
					      0xb, 0xb, 0xc, 0xd,  0xe,
					      0xe, 0xf, 0xf, 0x10, 0x11 };
unsigned int m12_36_dphy_range_bpg_ofs[15] = { 0x24, 0x4,  0x0,	 0x3e, 0x3c,
					       0x3a, 0x38, 0x38, 0x38, 0x36,
					       0x36, 0x36, 0x34, 0x34, 0x34 };
