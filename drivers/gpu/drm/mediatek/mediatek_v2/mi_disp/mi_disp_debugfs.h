...
#else
static inline int mi_disp_debugfs_init(void *d_display, int disp_id)
{
	return 0;
}
static inline int mi_disp_debugfs_deinit(void *d_display, int disp_id)
{
	return 0;
}
static inline bool is_enable_debug_log(void)
{
	return 0;
}
#endif
