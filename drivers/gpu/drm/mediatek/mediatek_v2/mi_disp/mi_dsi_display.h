...
ssize_t dsi_display_get_disp_param(struct drm_connector *connector, char *buf);
ssize_t dsi_display_set_disp_param(struct drm_connector *connector,
				   u32 param_type);

ssize_t mi_dsi_display_write_led_i2c_reg(void *display, char *buf,
					 size_t count);
...
int mi_dsi_display_get_doze_brightness(void *display, u32 *brightness);
